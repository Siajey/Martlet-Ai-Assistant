...
//charts components we need for store-maker page
...
function page() {
  ...
  return (
    <div
      ...
      id='store-maker-page-1-fully-container'
    >
      {/* Navbar-section */}
      <nav
      ...
      <div
        ...
        id='store-maker-page-1-section-container'
        style={{
          marginRight: '300px',
          marginLeft: '300px',
        }}
        ...
        >
          ...
          <div className=''>
            ...
            >
              ...
              {/* cards-section */}
              <div
                id='store-maker-page-1-cards-container'
            ...
            {/* store-maker-page-charts */}
            <div className='flex justify-center items-center gap-10 mt-10'>
              <ThirdRadarChart />
              <SimpleSecondLineChart />
            </div>
          </div>
        </div>
      </div>
