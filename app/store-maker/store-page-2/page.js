...
function page() {
  ...
  return (
    <div
      id='store-maker-page-2-fully-container'
      ...
      <div id='store-maker-page-2-section-container' className='h-[100vh]'>
        ...
        <div className='flex justify-center items-center mt-20'>
          <div className='flex flex-row-reverse justify-between items-center w-[1130px]'>
            ...
            <div className='flex justify-center items-center'>
              <p className='font-light text-[16px] text-[#1E1E1E] leading-[24px] ml-48'>
                عنوان
              </p>
            </div>
            <div className='flex justify-center items-center'>
        ...
        >
          ...
          >
            ...
            {/*title-container*/}
            <div
              className='flex justify-center items-center w-[142px] h-[50px] rounded-[15px]'
              style={{ backgroundColor: 'rgba(93, 95, 239, 0.1)' }}
            >
              <p className='font-bold text-[16px] leading-[28px] text-[#5D5FEF]'>
                مدیر وبسایت
              </p>
            </div>
            <div className='w-[49px] transfer rotate-90 border-[2px] border-[#1E1E1E] opacity-[10%]' />
