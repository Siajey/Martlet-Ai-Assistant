...
import GAPage4UploadImageIcon from '@/public/assets/icons/GA-page-4-upload-image-icon.svg'
...
function page() {
  ...
  // nav-selector Links - handle the active Links on the Nav selector
  const router = usePathname()

  const navSelectorLinks = [
    {
      href: '/graphic-assistant/ga-page-3',
      name: 'ویرایش متن',
      img: TextEditorIcon,
    },
    {
      href: '/graphic-assistant/ga-page-4',
      name: 'آپلود تصویر',
      img: UploadImageIcon,
    },
    {
      href: '/graphic-assistant/ga-page-5',
      name: 'سایر جزییات',
      img: OtherDetailsIcon,
    },
  ]
        ...
        >
          ...
          <div className='flex items-center cursor-pointer'>
            ...
            <div className='ml-5 mr-[14px]'>
              <Image src={YellowNotificationIcon} alt='yellow-icon' />
            </div>
            {/* collapse-menu */}
            <div
            ...
            >
              ...
              >
                <div className='w-[22.18px] h-[22.17px]'>
                  <Image
                    src={BusinessLitsItem1Logo}
                    alt='BusinessLitsItem1Logo'
                  />
                </div>
              </div>
              ...
              >
                ...
                >
                  <div className='w-[10px] h-[5px]'>
                    <Image
                      src={DashboardDropdwonIcon}
                      alt='DashboardDropdwonIcon'
                    />
                  </div>
                </div>
              </div>
                  ...
                  <ul>
                    <li id='business-lits-item-1'>
                      ...
                      >
                        ...
                        >
                          <div className='w-[22.18px] h-[22.17px]'>
                            <Image
                              src={BusinessLitsItem2Logo}
                              alt='BusinessLitsItem2Logo'
                            />
                          </div>
                        </div>
                        {/* Text section of the dropdown */}
                    ...
                    <li id='business-lits-item-2'>
                      ...
                      >
                        ...
                        >
                          <div className='w-[22.18px] h-[22.17px]'>
                            <Image
                              src={BusinessLitsItem3Logo}
                              alt='BusinessLitsItem3Logo'
                            />
                          </div>
                        </div>
                        {/* Text section of the dropdown */}
                    ...
                    <li id='business-lits-item-3'>
                      ...
                      >
                        ...
                        >
                          <div className='w-[22.18px] h-[22.17px]'>
                            <Image
                              src={BusinessLitsItem4Logo}
                              alt='BusinessLitsItem4Logo'
                            />
                          </div>
                        </div>
                        {/* Text section of the dropdown */}
                    ...
                    <li id='business-lits-item-add-button'>
                      ...
                      >
                        ...
                        <button>
                          <Image src={PurplePlusIcon} alt='PurplePlusIcon' />
                        </button>
        ...
        <div id='' className='flex justify-center items-center '>
          ...
          >
            ...
            <div className='flex flex-row-reverse justify-center items-center cursor-pointer gap-[20px]'>
              {/* map over the navSelector Links */}
              {navSelectorLinks.map((link) => {
                const isActiveNavSelectorLink = router.startsWith(link.href)
                return (
                  <Link href={link.href}>
                    <div
                      className={`flex flex-row-reverse justify-center items-center ${
                        isActiveNavSelectorLink
                          ? 'border-b-[2px] border-b-[#5D5FEF] p-2'
                          : null
                      }`}
                    >
                      <Image src={link.img} alt='TextEditorIcon' />
                      <p
                        className={`font-normal text-[14px] text-[#1E1E1E] leading-[20px] mr-3 ${
                          isActiveNavSelectorLink
                            ? 'font-bold text-[15px]'
                            : null
                        }`}
          ...
          >
            ...
            <div className='flex justify-center items-center w-[740px] h-[896px] rounded-[20px] bg-[#FFFFFF]'>
              ...
              <div className='w-[739px] h-[739px]'>
                ...
                >
                  <Image
                    src={GApage3SelectedProductPreviewImgLayer1}
                    alt='GApage3SelectedProductPreviewImgLayer1'
                  />
                  <div
                  ...
                  >
                    <Image
                      src={GApage3SelectedProductPreviewImgLayer2}
                      alt='GApage3SelectedProductPreviewImgLayer2'
                    />
                  </div>
                </div>
              </div>
            ...
            >
              {/* inputs */}
              <div
                className='flex justify-center items-center w-[452px] h-[100px] rounded-[16px]'
                style={{
                  backgroundColor: 'rgba(255, 255, 255, 0.5)',
                  position: 'relative', // Adding position relative to allow absolute positioning of the input
                }}
              >
                <input
                  type='file'
                  className='absolute inset-0 opacity-0 cursor-pointer' // Hide the default file input and allow the label to be clickable
                  style={{ zIndex: 1 }} // Ensure the input is clickable
                />
                <p className='font-medium text-[16px] text-[#303030] leading-[27px] mr-3'>
                  بارگزاری تصویر
                </p>
                <Image
                  src={GAPage4UploadImageIcon}
                  alt='GAPage4UploadImageIcon'
                />
              </div>
              {/* customer-uploaded-photo-container */}
              <div
                id='GA-page-4-customer-uploaded-photo-container'
                className='w-[540x] h-[650px]'
              ></div>
        ...
        >
          ...
          >
            ...
            <div className='flex justify-center items-center w-[28.8px] h-[28.8px] top-[14.4px]'>
              <Image src={GrayDashboardIcon} alt='GrayDashboardIcon' />
            </div>
          </div>
          <div
          ...
          >
            ...
            <Image src={ShoppingBagIcon} alt='ShoppingBagIcon' />
          </div>{' '}
          <div
            className='flex justify-center items-center gap-2'
          ...
          >
            ...
            <Image src={LineChartIcon} alt='LineChartIcon' />
          </div>{' '}
          <div
            className='flex justify-center items-center gap-2'
          ...
          >
            ...
            <Image src={MessagesIcon} alt='MessagesIcon' />
          </div>{' '}
          <div
                ...
                <ul className=''>
                  <li id='profile-collapse-list-item-1'>
                    <div className='flex  justify-end items-center'>
                      ...
                      <Image
                        src={RedExitProfileICon}
                        alt='RedExitProfileICon'
                      />
                    </div>
                  </li>
                  <li
                  ...
                  >
                    <div className='flex justify-end items-center'>
                      <Image
                        src={PurpleDiscountCode}
                        alt='PurpleDiscountCode'
                      />
                  ...
                  >
                    <div className='flex justify-end items-center'>
                      <Image
                        src={PurpleMembershipLevel}
                        alt='PurpleMembershipLevel'
                      />
                      <p className='font-medium text-[14px] text-[#151D48] leading-[24px]'>
                        سطح عضویت
                      </p>
                  ...
                  >
                    <div className='flex justify-end items-center'>
                      <Image
                        src={PurpleTransactions}
                        alt='PurpleTransactions'
                      />
                      <p className='font-medium text-[14px] text-[#151D48] leading-[24px]'>
                        تراکنش ها
                      </p>
                  ...
                  >
                    <div className='flex justify-end items-center'>
                      <Image src={AccountInfoIcon} alt='AccountInfoIcon' />
                      <p className='font-medium text-[14px] text-[#151D48] leading-[24px]'>
                        اطلاعات حساب
                      </p>
                    </div>
