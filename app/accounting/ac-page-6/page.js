...
function page() {
  ...
  return (
    <div
      id='accounting-page-6-fully-container'
    ...
    >
      ...
      <div id='accounting-page-6-section-container' className='h-[100vh]'>
        ...
        >
          ...
          {/* add-user-section */}
          <div className=''>
            <button className='flex justify-center items-center w-[200px] h-[54px] rounded-[31.5px] border-[3px] border-[#5D5FEF]'>
        ...
        <div className='flex justify-center items-center mt-20'>
          <div className='flex flex-row-reverse justify-between items-center w-[1230px]'>
        ...
        >
          <div
            id='accounting-page-6-search-result-item-box-1'
          ...
          >
            ...
            <div className='w-[49px] transfer rotate-90 border-[2px] border-[#1E1E1E] opacity-[10%]' />
            {/*title-container*/}
            <div className='flex justify-center items-center w-[10px] h-[50px] rounded-[15px]'>
              <p className='font-medium text-[16px] leading-[28px] '>111</p>
            </div>
            <div className='w-[49px] transfer rotate-90 border-[2px] border-[#1E1E1E] opacity-[10%]' />
            {/*title-container*/}
            <div className='flex justify-center items-center w-[10px] h-[50px] rounded-[15px]'>
              <p className='font-medium text-[16px] leading-[28px] '>بدهکار</p>
            </div>
            <div className='w-[49px] transfer rotate-90 border-[2px] border-[#1E1E1E] opacity-[10%]' />
            {/* buttons-container */}
          ...
          <div
            id='accounting-page-6-search-result-item-box-2'
          ...
          <div
            id='accounting-page-6-search-result-item-box-3'
            className='flex flex-row-reverse justify-between items-center w-[1235px] h-[93px] rounded-[30px] mt-10 p-10'
            style={{
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow:
          ...
          <div
            id='accounting-page-6-search-result-item-box-4'
            className='flex flex-row-reverse justify-between items-center w-[1235px] h-[93px] rounded-[30px] mt-10 p-10'
            style={{
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow:
          ...
          <div
            id='accounting-page-6-search-result-item-box-5'
            className='flex flex-row-reverse justify-between items-center w-[1235px] h-[93px] rounded-[30px] mt-10 p-10'
            style={{
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow:
      ...
      {/* accounting-page-6-footer-nav-menu */}
      <div
