...
//components imports
import UserCreationModal from '@/components/user-creation-custom-modal/UserCreationModal'

//assets we need for the accounting page-2 Navbar
...
//assets for dashboard footer menu accounting page2
...
function page() {
  ...
  return (
    <div
      id='accounting-page-2-fully-container'
    ...
    >
      ...
      <div id='accounting-page-2-section-container' className='h-[100vh]'>
        ...
        >
          ...
          {/* add-user-section */}
          <div className=''>
            <button className='flex justify-center items-center w-[161px] h-[54px] rounded-[31.5px] border-[3px] border-[#5D5FEF]'>
        ...
        <div className='flex justify-center items-center mt-20'>
          <div className='flex flex-row-reverse justify-between items-center w-[1130px]'>
            ...
            <div className='flex justify-center items-center'>
              <p className='font-light text-[16px] text-[#1E1E1E] leading-[24px] ml-64 mr-16'>
                تاریخ شروع
              </p>
            </div>
            <div className='flex justify-center items-center'>
              <p className='font-light text-[16px] text-[#1E1E1E] leading-[24px] ml-72'>
                تاریخ پایان
              </p>
            </div>
            <div className='flex justify-center items-center'>
              <p className='font-light text-[16px] text-[#1E1E1E] leading-[24px] ml-60'>
                عنوان
              </p>
            </div>
        ...
        >
          <div
            id='accounting-page-2-search-result-item-box-1'
        ...
        >
          <div
            id='accounting-page-2-search-result-item-box-2'
            className='flex flex-row-reverse justify-between items-center w-[1235px] h-[93px] rounded-[30px] p-10'
            style={{
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow:
        ...
        >
          <div
            id='accounting-page-2-search-result-item-box-3'
            className='flex flex-row-reverse justify-between items-center w-[1235px] h-[93px] rounded-[30px] p-10'
            style={{
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow:
        ...
        >
          <div
            id='accounting-page-2-search-result-item-box-4'
            className='flex flex-row-reverse justify-between items-center w-[1235px] h-[93px] rounded-[30px] p-10'
            style={{
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow:
        ...
        >
          <div
            id='accounting-page-2-search-result-item-box-5'
            className='flex flex-row-reverse justify-between items-center w-[1235px] h-[93px] rounded-[30px] p-10'
            style={{
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow:
      ...
      {/* accounting-page-2-footer-nav-menu */}
      <div
