...
function page() {
  ...
  return (
    <div
      id='accounting-page-5-fully-container'
    ...
    >
      ...
      <div id='accounting-page-5-section-container' className='h-[100vh]'>
        ...
        <div className='flex justify-center items-center mt-20'>
          <div className='flex flex-row-reverse justify-between items-center w-[1130px]'>
            ...
            <div className='flex justify-center items-center'>
              <p className='font-light text-[16px] text-[#1E1E1E] leading-[24px] ml-[250px]'>
                گروه
              </p>
            </div>
        ...
        >
          <div
            id='accounting-page-5-search-result-item-box-1'
          ...
          <div
            id='accounting-page-5-search-result-item-box-2'
          ...
          <div
            id='accounting-page-5-search-result-item-box-3'
            className='flex flex-row-reverse justify-between items-center w-[1235px] h-[93px] rounded-[30px] mt-10 p-10'
            style={{
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow:
          ...
          <div
            id='accounting-page-5-search-result-item-box-4'
            className='flex flex-row-reverse justify-between items-center w-[1235px] h-[93px] rounded-[30px] mt-10 p-10'
            style={{
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow:
          ...
          <div
            id='accounting-page-5-search-result-item-box-5'
            className='flex flex-row-reverse justify-between items-center w-[1235px] h-[93px] rounded-[30px] mt-10 p-10'
            style={{
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow:
