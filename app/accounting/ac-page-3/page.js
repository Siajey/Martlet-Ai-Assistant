...
function page() {
  ...
  return (
    <div id='accounting-page-3-fully-container'>
      {/* Navbar-section */}
      <nav
      ...
      <div id='accounting-page-3-section-container' className='h-[100vh]'>
        ...
        >
          <div
            id='accounting-page-3-search-result-item-box-1'
          ...
          >
            ...
            {/*title-container*/}
            <div className='flex justify-center items-center w-full h-[50px] rounded-[15px]'>
          ...
          <div
            id='accounting-page-3-search-result-item-box-2'
          ...
          <div
            id='accounting-page-3-search-result-item-box-3'
            className='flex flex-row-reverse justify-between items-center w-[1235px] h-[93px] rounded-[30px] mt-10 p-10'
            style={{
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow:
          ...
          <div
            id='accounting-page-3-search-result-item-box-4'
            className='flex flex-row-reverse justify-between items-center w-[1235px] h-[93px] rounded-[30px] mt-10 p-10'
            style={{
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow:
          ...
          <div
            id='accounting-page-3-search-result-item-box-5'
            className='flex flex-row-reverse justify-between items-center w-[1235px] h-[93px] rounded-[30px] mt-10 p-10'
            style={{
              backgroundColor: 'rgba(255, 255, 255, 0.3)',
              boxShadow:
      ...
      {/* accounting-page-3-footer-nav-menu*/}
      <div
