    ...
    >
      <ResponsiveContainer width='100%' height='100%'>
        ...
        >
          ...
          <CartesianGrid className='bg-[#ECECEC] border-[0.96px]' />
          <Legend />
          <ReferenceLine y={0} stroke='#000' />
          <Tooltip />
          <Bar dataKey='product1' type='monotone' stroke='' fill='#5D5FEF' />
          <Bar dataKey='product2' type='monotone' stroke='' fill='#DD40D7' />
          <Bar dataKey='product3' type='monotone' stroke='' fill='#9040DD' />
        </BarChart>
      </ResponsiveContainer>
    </div>
  )
